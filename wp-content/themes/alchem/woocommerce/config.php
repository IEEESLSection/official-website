...
function woocommerce_header_add_to_cart_fragment( $fragments ) {
	...
	?>
	<a class="cart-contents" href="<?php echo $woocommerce->cart->get_cart_url(); ?>" title="<?php _e('View your shopping cart', 'alchem'); ?>"><?php echo sprintf(_n('%d item', '%d items', $woocommerce->cart->cart_contents_count, 'alchem'), $woocommerce->cart->cart_contents_count);?> - <?php echo $woocommerce->cart->get_cart_total(); ?></a>
	<?php
	...
	*/
	function alchem_woocommerce_recently_viewed_products(  ) {
	    ...
	    if ( empty( $viewed_products ) )
	        return __( 'You have not viewed any product yet!', 'alchem' );
