        ...
        <div id="" class=" row">
          <div class="col-md-6">
            <div class="<?php echo $alchem_home_animation;?>" data-animationduration="0.9" data-animationtype="bounce" data-imageanimation="no" id="">
              <h1 class="magee-heading" id=""><span class="heading-inner <?php echo 'alchem_section_0_title_'.$i;?>" style="font-family: 'Poiret One'"><?php echo do_shortcode($title);?></span></h1>
            </div>
            <p style="text-align:center; font-size: 20px;" class="<?php echo 'alchem_section_0_sub_title_'.$i;?>"><?php echo do_shortcode($sub_title);?></p>
