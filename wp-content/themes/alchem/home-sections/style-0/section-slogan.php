<?php 
 ...
 <section class="<?php echo $section_class;?>" id="<?php echo $section_id;?>">
  ...
  <?php if( $section_title != '' ):?>
    <h2 style="text-align: center" class="section-title alchem_section_10_title"><?php echo $section_title;?></h2>
    ...
    <?php endif;?>
    <?php if( $sub_title != '' ):?>
    <div class="section-subtitle alchem_section_10_sub_title"><?php echo do_shortcode($sub_title);?></div>
