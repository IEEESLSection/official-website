...
<div class="container-fullwidth alchem_section_3_model">
<?php if( $content_model == 0 ):?>
<?php if( $section_title != '' ):?>
    <h2 class="section-title alchem_section_3_title"><?php echo $section_title;?></h2>
    <div style="text-align:center;" class="alchem_section_3_sub_title"><?php echo do_shortcode($sub_title);?></div>
