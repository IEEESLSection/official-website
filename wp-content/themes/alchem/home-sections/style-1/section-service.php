<?php 
 ...
 <?php if( $section_hide != '1' ):?>
  ...
  <?php if( $section_title != '' ):?>
    ...
    <div style="text-align:center;" class="alchem_section_2_sub_title"><?php echo do_shortcode($sub_title);?></div>
	...
	'.$icon.'<span style="font-family: \'Cuprum\';font-weight:bold;font-size:18px;" class="alchem_section_2_feature_title_'.$j.'">'.$title.'</span><br>
<span class="alchem_section_2_feature_content_'.$j.'">'.do_shortcode($feature_content).'</span><br>
</div></div>';
