...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'alchem' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'alchem' ) ) ) );
...
function customizer_library_get_google_font_uri( $fonts ) {
	...
	$subset = alchem_option( 'font-subset', customizer_library_get_default( 'font-subset' ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'alchem' ),
		'cyrillic'     => __( 'Cyrillic', 'alchem' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'alchem' ),
		'devanagari'   => __( 'Devanagari', 'alchem' ),
		'greek'        => __( 'Greek', 'alchem' ),
		'greek-ext'    => __( 'Greek Extended', 'alchem' ),
		'khmer'        => __( 'Khmer', 'alchem' ),
		'latin'        => __( 'Latin', 'alchem' ),
		'latin-ext'    => __( 'Latin Extended', 'alchem' ),
		'vietnamese'   => __( 'Vietnamese', 'alchem' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'alchem' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'alchem' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'alchem' ),
