 ...
 */ {
	function customizer_library_register( $wp_customize ) {
		...
		'selector' => '.site-name',
		'render_callback' => 'alchem_customize_partial_blogname',
		) );
		$wp_customize->selective_refresh->add_partial( 'blogdescription', array(
			'selector' => '.site-tagline',
			'render_callback' => 'alchem_customize_partial_blogdescription',
		) );
 ...
 * @return void
 */
function alchem_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function alchem_customize_partial_blogdescription() {
